...
- `registry/` contains provider-contract and account-facts tests.
...
- `antigravity/`, `claude/`, `codex/`, `copilot/`, `cursor/`, `gemini/`, `grok/`, `kimi/`, `minimax/`, `opencode_go/`, and `zai/` implement provider-specific behavior.
