...
codex-account-import-reauth-tooltip = Import OpenCode credentials for this Codex account
...
copilot-account-import-reauth-tooltip = Import OpenCode credentials for this Copilot account
...
codex-sign-in-with-chatgpt = Sign in with ChatGPT
...
kimi-accounts-empty = No Kimi accounts
...
kimi-login-saved = Kimi account added
...
opencode-go-accounts-empty = No OpenCode Go accounts configured.
opencode-go-account-select-required = Select an OpenCode Go account.
opencode-go-login-editing = Enter your OpenCode Go API key.
opencode-go-login-saved = OpenCode Go account saved.
